...
import {Asset, CategoryApi} from "client";
...
const AddCategoryModal: React.FC<IProps> = (props: IProps) => {
	...
	async function saveCategory(): Promise<void> {
		...
		try {
			await new CategoryApi(getConfig(props.token)).createCategory({
				createCategoryBody: {
					name,
					imageID: asset?._id,
				},
	...
	return (
		<React.Fragment>
			...
			>
				<ModalHeader toggle={resetAndClose}>Create New Category</ModalHeader>
